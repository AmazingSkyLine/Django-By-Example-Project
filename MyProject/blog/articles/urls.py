...
urlpatterns = [
    ...
    path('manage/comment/<int:article_id>', views.comment_manage, name='comment_manage'),
    path('manage/comment/delete/<int:comment_id>', views.comment_manage_delete, name='comment_manage_delete'),
    path('manage/comment/stat/<int:comment_id>', views.comment_manage_stat, name='comment_manage_stat'),
